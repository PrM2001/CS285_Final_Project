...
d = sf.V2.symbolic("disturbance") #2d
...
q_reset = q
q_reset[0] = q_reset[0] + d[0]
reset_map = q_reset.col_join(f_r * dq + d[1]) 
...
codegen_dynamics("double_integrator_dynamics_2d_disturbance", state, u, d, dt, fvec, gvec, reset_map)
